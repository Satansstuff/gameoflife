...
{
    auto instance = render::openWindow(glm::uvec2(1920,1080), "Game Of Life", false, []()
    {
    ...
    camera::build([&]()
    {
        cam.projection = glm::perspective(glm::radians(60.0), render::getAspectRatio(), 0.1, 100.0);
